...
<x-enhanced-navlist-group :heading="__('MAIN')" icon="layout-dashboard" color="green">
    <flux:navlist.item 
        ...
        wire:navigate 
        class="relative mb-2 rounded-lg px-3 py-3 text-sm font-medium transition-all duration-200 ease-in-out hover:bg-stone-100/80 hover:scale-[1.02] dark:hover:bg-stone-800/60 group"
    >
...
<x-enhanced-navlist-group :heading="__('INVENTORY')" icon="box" color="blue">
    <flux:navlist.item 
        ...
        wire:navigate 
        class="relative mb-2 rounded-lg px-3 py-3 text-sm font-medium transition-all duration-200 ease-in-out hover:bg-blue-50/80 hover:scale-[1.02] dark:hover:bg-blue-900/20 group"
    >
        <span class="flex items-center">
            {{ __('ICS Management') }}
...
<x-enhanced-navlist-group :heading="__('DATA')" icon="layout-grid" color="purple">
    <flux:navlist.item 
        ...
        wire:navigate 
        class="relative mb-2 rounded-lg px-3 py-3 text-sm font-medium transition-all duration-200 ease-in-out hover:bg-purple-50/80 hover:scale-[1.02] dark:hover:bg-purple-900/20 group"
    >
        <span class="flex items-center">
            {{ __('Items & Categories') }}
...
<x-enhanced-navlist-group :heading="__('SYSTEM')" icon="folder-git-2" color="red">
    <flux:navlist.item 
        ...
        wire:navigate 
        class="relative mb-2 rounded-lg px-3 py-3 text-sm font-medium transition-all duration-200 ease-in-out hover:bg-red-50/80 hover:scale-[1.02] dark:hover:bg-red-900/20 group"
    >
        <span class="flex items-center">
            {{ __('Audit Logs') }}
