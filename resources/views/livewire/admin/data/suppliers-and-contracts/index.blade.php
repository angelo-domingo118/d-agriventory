    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div>
            <flux:breadcrumbs class="text-2xl font-semibold">
                ...
                <flux:breadcrumbs.item class="text-xl sm:text-2xl font-semibold text-stone-900 dark:text-stone-100">Suppliers & Contracts</flux:breadcrumbs.item>
            </flux:breadcrumbs>
        </div>
    </div>
...
<div x-data="{ 
    ...
    view: localStorage.getItem('suppliers_contracts_view') || '{{ request()->query('view', 'tree') }}',
    init() {
        // Watch for view changes and save to localStorage
        this.$watch('view', value => {
            localStorage.setItem('suppliers_contracts_view', value);
        });
    }
}">
    ...
    <div class="mt-8">
        <div x-show="view === 'tree'" x-cloak>
            <livewire:admin.data.suppliers-and-contracts.tree-view />
        </div>
