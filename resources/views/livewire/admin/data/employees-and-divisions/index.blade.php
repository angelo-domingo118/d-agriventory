...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    public function mount()
    {
        ...
        $this->currentTab = request()->query('currentTab', 'divisions');
    }
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div>
            <flux:breadcrumbs class="text-2xl font-semibold">
                ...
                <flux:breadcrumbs.item class="text-xl sm:text-2xl font-semibold text-stone-900 dark:text-stone-100">Employees & Divisions</flux:breadcrumbs.item>
            </flux:breadcrumbs>
        </div>
    </div>
...
<div x-data="{ 
    ...
    view: localStorage.getItem('employees_divisions_view') || '{{ request()->query('view', 'tree') }}',
    init() {
        // Watch for view changes and save to localStorage
        this.$watch('view', value => {
            localStorage.setItem('employees_divisions_view', value);
        });
    }
}">
