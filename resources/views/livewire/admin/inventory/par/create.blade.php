...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    public function mount(): void
    {
        ...
        // Set default dates - removed auto-filling of date_prepared
    }
    ...
    public function store(): void
    {
        ...
        try {
            ...
            $final_contract_item = ContractItem::firstOrCreate(
                ...
                ['unit_price' => $this->unit_price, 'item_type' => 'PAR']
            );

            $parNumber = ParNumber::create([
    ...
    <div class="border-b border-stone-200 pb-4 dark:border-stone-700">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-x-4">
                ...
                <flux:button type="submit" variant="primary" :disabled="$isIcsItem">
                    Save Record
                </flux:button>
            </div>
        </div>
                    ...
                    <div class="p-4">
                        <div class="space-y-4">
                            ...
                            <div class="border-t border-stone-200 pt-4 dark:border-stone-700">
                                ...
                                @if ($isIcsItem)
                                    <div class="mt-4 flex w-full items-center rounded-lg bg-yellow-50 p-3 text-sm text-yellow-700 dark:bg-yellow-800/20 dark:text-yellow-400" role="alert">
                                        ...
                                        <span class="font-medium">
                                            The unit cost of ₱{{ number_format($this->unit_price, 2) }} for this item is under ₱50,000. It should be recorded using an ICS form instead.
                                        </span>
                                    </div>
                                @endif
                            </div>
