...
class EmployeeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $employeeNames = [
            ...
            'GEMINO, Imelda',
            'GOLONAN, Arlina',
            'GOMINZA, Jael Jonalyn',
            'GONZALES, Lera',
            'GOYO, Bentres',
            'GUZMAN, Delilah Jesusa',
            'HUMIWAT, Nestor',
            'JAVIER, Arnel',
            'JAVIER, Maria Kristina Mercedes',
            'JIMENEZ, Lea Lynn',
            'KALNGAN, Angeline',
            'KIGIS, Karl Glenn',
            'KIO-ISEN, Mae',
            ...
            'PINOS-AN, Pedro',
            'POLON, Reynaldo',
            'POTECTAN, Jelly Pearl',
            'QUEVADA, John Patrick',
            'RANILLE, Ryan',
            'RILLERA, Jikiri',
            'ROSADO, Jerson',
            'ROSARIO, Crisante',
