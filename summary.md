...
Complete index of D'Agriventory documentation with brief descriptions for quick navigation.

## core-documentation

1. **[README.md](README.md)** - Quick project overview, 5-minute setup guide, and first-run commands
2. **[summary.md](summary.md)** - This file; ordered index of all documentation with descriptions
3. **[CONTRIBUTING.md](CONTRIBUTING.md)** - Guidelines for contributing documentation changes and markdown standards

## project-guides

4. **[docs/overview.md](docs/overview.md)** - Project purpose, complete tech stack breakdown, and directory structure
...
- **New to Laravel?** Start with [overview.md](docs/overview.md) then [ui-stack.md](docs/ui-stack.md)
- **Ready to code?** Review [coding-standards.md](docs/coding-standards.md) and [workflow.md](docs/workflow.md)
- **Deployment questions?** Check [database.md](docs/database.md) and [faq.md](docs/faq.md)
- **Contributing?** Read [CONTRIBUTING.md](CONTRIBUTING.md) for documentation standards